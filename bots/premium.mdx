...
- 📊 Track premium user base accurately
...
| `monthly` | Current date + 1 month | Dec 25 → Jan 25 |
...
<CardGroup cols={2}>
  <Card title="Vote Webhooks" icon="star" href="/bots/vote">
    Handle user votes and grant rewards in real-time
  </Card>
  <Card title="API Integration" icon="code" href="/bots/api-integration">
    Use the REST API in your bot commands
  </Card>
  <Card title="Server Webhooks" icon="webhook" href="/servers/webhooks">
    Set up server-side webhook integration
  </Card>
</CardGroup>
